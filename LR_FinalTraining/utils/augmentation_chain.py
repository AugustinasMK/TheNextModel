...
class random_perspective_transform(object):
    def __init__(self, sigma=None, crop=None):
        if sigma is None:
            sigma = [0, 50]
        if crop is None:
            crop = [0, 1]
...
class random_padding(object):
    def __init__(self, w_factor=None, h_factor=None, color_1=None, color_2=None, color_3=None):
        if w_factor is None:
            w_factor = [0, 0.1]
        if h_factor is None:
            h_factor = [0, 0.1]
...
class random_image_underlay(object):
    def __init__(self, path='/media/augustinas/T7/DISC2021/SmallData/images/train/', which=None, new_size=None,
                 shapx_pos=None, x_pos=None, y_pos=None):
        if which is None:
            which = [0, 10000]
        if new_size is None:
            new_size = [0.04, 0.1]
        if shapx_pos is None:
            shapx_pos = [0, 0.5]
        if x_pos is None:
            x_pos = [0, 0.5]
        if y_pos is None:
...
class random_emoji_overlay(object):
    def __init__(self, opacity=None, emoji_size=None, x_pos=None, y_pos=None, p=0.5):
        if opacity is None:
            opacity = [0, 1]
...
class random_text_overlay(object):
    def __init__(self, num=2, text=None, color_1=None, color_2=None, color_3=None, font_size=None,
                 opacity=None, x_pos=None, y_pos=None, p=0.5):
        if text is None:
            text = [0, 20]
        if color_1 is None:
            color_1 = [0, 255]
...
class random_image_overlay(object):
    def __init__(self, path='/media/augustinas/T7/DISC2021/SmallData/images/train/', which=None,
                 new_size=None, shapx_pos=None, x_pos=None, y_pos=None):
        if which is None:
            which = [0, 10000]
        if new_size is None:
            new_size = [2.5, 3.5]
...
class random_image_opaque(object):
    def __init__(self, opa=None, path='/media/augustinas/T7/DISC2021/SmallData/images/train/', which=None):
        if opa is None:
            opa = [0.2, 1.0]
        if which is None:
            which = [0, 10000]
