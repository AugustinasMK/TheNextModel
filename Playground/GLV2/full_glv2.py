...
if __name__ == '__main__':
    # Load the dataset
    dataset = load_dataset("imagefolder", name="glv2-next-vit", data_dir="/scratch/lustre/home/auma4493/images/LANDV2/",
                       drop_labels=True)
    ...
    saved_states = torch.load("/scratch/lustre/home/auma4493/TheNextModel/GLV2/checkpoints4/trained_model_5_5.pth")
    model.load_state_dict(saved_states['model_state_dict'])
    
    print("/scratch/lustre/home/auma4493/TheNextModel/GLV2/checkpoints4/trained_model_5_5.pth")
    ...
    print(matrix)
    print(matrix.shape)
    np.save("/scratch/lustre/home/auma4493/TheNextModel/GLV2/data4/5/glv2_matrix_no_norm.npy", matrix)
    ...
    print(matrix.shape)
    # Save the matrix
    np.save("/scratch/lustre/home/auma4493/TheNextModel/GLV2/data4/5/glv2_matrix_norm.npy", matrix)