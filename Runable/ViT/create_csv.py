...
similarity = np.load('/scratch/lustre/home/auma4493/TheNextModel/Runable/ViT/disc_matrix_no_norm.npy')
...
with open('/scratch/lustre/home/auma4493/TheNextModel/Runable/ViT/disc_no_norm.csv', 'w') as file:
