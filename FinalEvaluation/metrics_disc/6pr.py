...
if __name__ == "__main__":
    ...
    disc_precisions = np.load('disc_disc_precisions.npy')
    disc_recalls = np.load('disc_disc_recalls.npy')

    glv2q_precisions = np.load('disc_q_precisions.npy')
    glv2q_recalls = np.load('disc_q_recalls.npy')

    glv2t_precisions = np.load('disc_t_precisions.npy')
    glv2t_recalls = np.load('disc_t_recalls.npy')
